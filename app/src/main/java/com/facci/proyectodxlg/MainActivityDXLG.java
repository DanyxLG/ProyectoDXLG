package com.facci.proyectodxlg;
...
import com.facci.proyectodxlg.SQLITEOPENHELPER.DBhelper;
public class MainActivityDXLG extends AppCompatActivity  {
...
/*
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_main_activity_dxlg);
    ...
    public void InsetarBtn (View v) {
        ...
        if (Insertadatos) {
            Toast.makeText(MainActivityDXLG.this, "Datos Ingresados", Toast.LENGTH_SHORT).show();
        }else{Toast.makeText(MainActivityDXLG.this,"Datos no Ingresados ocurrio un error",Toast.LENGTH_SHORT).show();}
    }
    ...
    public void Modificar (View v) {
        ...
        if(ActualizandoDatos)
            ...
            Toast.makeText(MainActivityDXLG.this,"Lo sentimos ocurrió un error",Toast.LENGTH_SHORT).show();
    ...
    public void Eliminar (View v) {
        ...
        if(registrosEliminados > 0 ){
            Toast.makeText(MainActivityDXLG.this,"Registro(s) Eliminado(s)",Toast.LENGTH_SHORT).show();
        }else{
            Toast.makeText(MainActivityDXLG.this,"ERROR: Registro no eliminado",Toast.LENGTH_SHORT).show();
        }
    }
